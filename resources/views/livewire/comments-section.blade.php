        ...
        <div class="flex">
            ...
            <div class="ml-4 flex-1">
                <textarea wire:model.defer="comment" name="comment" id="comment" rows="4" placeholder="Type your comment here..."
                          class="@error('comment')border border-red-500 @enderror form-input block w-full py-3 px-4 placeholder-gray-500 transition ease-in-out duration-150">{{ old('comment') }}</textarea>
